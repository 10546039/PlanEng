...
public class testreviewActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addreview_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(testreviewActivity.this , Review_add_Activity.class);
        ...
        rplanbt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(testreviewActivity.this , planreviewActivity.class);
                intent.putExtra("m_id", m_id);
                startActivity(intent);
            }
        });
    ...
    private void getBook2() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (success) {
                        ...
                        android.app.AlertDialog.Builder builder = new AlertDialog.Builder(testreviewActivity.this);
        ...
        String m_id ="6";
        getTplan get = new getTplan( m_id , responseListener1);
        RequestQueue queue1 = Volley.newRequestQueue(testreviewActivity.this);
        queue1.add(get);
        ...
        for (  k = 0; k < r_data.size(); k++) {
            ...
            MoreBt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    bookIntent.setClass(testreviewActivity.this,Review_out_Activity.class);
